...
export const metadata: Metadata = {
  title: "Zoo Madrid | Wildlife Experience in Spain",
  description: "Discover 6,000+ animals from around the world at Zoo Madrid. Explore immersive habitats, educational programs, and family-friendly experiences.",
  keywords: "zoo madrid, wildlife, animals, family attraction, conservation, education",
  metadataBase: new URL("https://zoomadrid.es"),
  alternates: {
    canonical: "https://zoomadrid.es"
  },
  openGraph: {
    title: "Zoo Madrid | Europe's Premier Wildlife Experience",
    description: "Experience the wonder of global wildlife at Zoo Madrid. Over 50 years of conservation, education, and family entertainment.",
    url: "https://zoomadrid.es",
    siteName: "Zoo Madrid",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=fk6711",
      alt: "Zoo Madrid entrance"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Zoo Madrid | Wildlife Experience",
    description: "Visit Zoo Madrid and explore 6,000+ animals in immersive habitats.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=fk6711"]
  }
};
